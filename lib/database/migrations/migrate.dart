...
import 'add_play_catalog_columns_to_bling_packages.dart';
import 'add_commission_columns.dart';
import 'add_ad_campaign_columns.dart';
import 'add_location_targeting_to_ads.dart';
...
import 'add_location_profile_fields_to_users.dart';
...
class Migrate {
  registry() async {
    ...
    await AddPlayCatalogColumnsToBlingPackages().up();
    await AddCommissionColumns().up();
    await AddAdCampaignColumns().up();
    await AddLocationTargetingToAds().up();
    ...
    await AddLocationProfileFieldsToUsers().up();
  ...
  dropTables() async {
    ...
    await AddLocationProfileFieldsToUsers().down();
    await CreateOtpsTable().down();
    await AddLocationTargetingToAds().down();
    ...
    await AddPlayCatalogColumnsToBlingPackages().down();
